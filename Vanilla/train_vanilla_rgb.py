...
from Vanilla.RN_Vanilla_Softmax import RNVanillaSoftmax
...
if __name__ == '__main__':
    ...
    net = RNVanilla(pretrained=False, input_dim=input_dim).train().cuda()
    ...
    split = 'train'
    seg_dir = '/home/yangzehua/UCF_Crimes/RGB_Segments'
    # test_seg_dir = os.path.join(seg_dir, 'test')
    test_seg_dir = '/home/yangzehua/UCF_Crimes/CADP_RGB_Segments/test'
    ...
    model_save_dir = 'Vanilla_RGB_CADP.pt'
    graph_save_dir = 'Vanilla_RGB_CADP.png'

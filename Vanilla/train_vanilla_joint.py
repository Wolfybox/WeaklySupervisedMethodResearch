...
from loss_function import ranking_loss_max, continuity_loss, sparse_loss
from Vanilla.RN_Vanilla_Joint import RNVanillaJoint
...
if __name__ == '__main__':
    ...
    net = RNVanillaJoint(pretrained=False, input_dim=input_dim).train().cuda()
    ...
    split = 'train'
    seg_dir = '/home/yangzehua/UCF_Crimes/CAT_Segments'
    ...
    model_save_dir = 'Vanilla_JOINT.pt'
    graph_save_dir = 'Vanilla_JOINT.png'
    ...
    for epoch in tqdm(range(epoch_num)):
        ...
        if (epoch + 1) % 10 == 0:
            ...
            if cur_auc > auc and epoch_loss < 5e-2:

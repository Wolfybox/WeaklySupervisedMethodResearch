...
from Vanilla.RN_Vanilla_CAT import RNVanillaCat
...
if __name__ == '__main__':
    ...
    net = RNVanillaCat(pretrained=False, input_dim=input_dim).train().cuda()
    ...
    # test_seg_dir = os.path.join(seg_dir, 'test')
    model_save_dir = 'Vanilla_CAT.pt'
    graph_save_dir = 'Vanilla_CAT.png'
